...
//
//import com.fleta.purchasingservice.config.KafkaProperties;
...
//
//@RestController
//@RequestMapping("/api/purchasing-service-kafka")
//public class PurchasingServiceKafkaController {
//
//    private final Logger log = LoggerFactory.getLogger(PurchasingServiceKafkaController.class);
//
//    private final KafkaProperties kafkaProperties;
//    private Producer<String, String> sender;
//
//    public PurchasingServiceKafkaController(KafkaProperties kafkaProperties) {
//        this.kafkaProperties = kafkaProperties;
//        this.sender = new KafkaProducer<String, String>(kafkaProperties.getProducerProps());
//    }
//
...
//            metadata = sender.send(record).get();
